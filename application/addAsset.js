    ...
    try {
        ...
        try {
            ...
            for (let i = 0; i < concurrentTxs; i++) {
                timer(`L#${i}`);
                contract.submitTransaction('AddAsset', `${uuidv4()}`,
                    'f55755d0-2b34-11ef-8184-e9ddcaf616ac', 
                    'f5599fc0-2b34-11ef-8184-e9ddcaf616ac', 
                    'd7dcfd60-2b35-11ef-a136-eb2f20063732').then(result => {
